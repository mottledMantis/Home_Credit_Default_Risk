...
2. bureau.csv - each client's previous creidit as provided by a credit bureau
3. beareau_balance.csv - each client's monthly credit balances as provided by a credit bureau
...
5. Use visualization tools to deomonstrate these correlations, the accuracy of the model as applied to the train data, and the results of the model as applied to the test data.
