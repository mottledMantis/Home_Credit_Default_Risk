...
plot(ROCRperf, colorize = TRUE, print.cutoffs.at = seq(0,1,.1), text.adj = c(-0.2, 1.7), main = "GLM")
...
View(RFModelEval)
saveRDS(rf_predict_05, "./rf_predict_05.rds")
remove(rf_predict_05)
...
View(RFModelEval)
saveRDS(rf_predict_10, "./rf_predict_10.rds")
remove(rf_predict_10)
...
View(RFModelEval)
saveRDS(rf_predict_20, "./rf_predict_20.rds")
remove(rf_predict_20)
...
View(RFModelEval)
saveRDS(rf_predict_30, "./rf_predict_30.rds")
remove(rf_predict_30)
...
View(RFModelEval)
saveRDS(rf_predict_60, "./rf_predict_60.rds")
remove(rf_predict_60)
...
View(RFModelEval)
saveRDS(rf_predict_80, "./rf_predict_80.rds")
remove(rf_predict_80)
...
ConfMat_100 <- table(results_train_Test$TARGET, predictTest_100 > .5)
ConfMat_100
...
View(RFModelEval)
saveRDS(rf_predict_100, "./rf_predict_100.rds")
remove(rf_predict_100)
