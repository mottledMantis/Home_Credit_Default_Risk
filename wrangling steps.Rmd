...
2. created "results" data frame into which I will dump relevant columns from source data sets, including "application_all" - I will continue to add columns that present simplified data from multiple row in complex data sets AND relevant info from "application_all"
